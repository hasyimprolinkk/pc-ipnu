			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="/"><i class="icon-copy dw dw-home"></i> Home</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<div class="sidebar-small-cap mt-1">Transaksi Data</div>
					</li>
					<li>
						<a href="/kegiatan/add" class="dropdown-toggle no-arrow {{request()->is('kegiatan/add') ? 'active' : ''}}">
							<span class="micon dw dw-list"></span><span class="mtext">Tambah Kegiatan</span>
						</a>
					</li>
					<li>
						<a href="/kegiatan" class="dropdown-toggle no-arrow {{request()->is('kegiatan') ? 'active' : ''}}">
							<span class="micon dw dw-list3"></span><span class="mtext">Data Kegiatan</span>
						</a>
					</li>
					<li>
						<a href="/kegiatan/print" class="dropdown-toggle no-arrow {{request()->is('kegiatan/print') ? 'active' : ''}}">
							<span class="micon dw dw-print"></span>
							<span class="mtext">Print Kegiatan</span>
						</a>
					</li>
					@endif
					...
					<li>
						<a href="/users" class="dropdown-toggle no-arrow {{request()->is('users*') ? 'active' : ''}}">
