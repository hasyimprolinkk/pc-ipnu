                    ...
                    <tbody>
                        @foreach ($kategori as $k)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#confirmation-modal_{{$k->id_kategori}}" class="btn btn-lg btn-danger"><i class="dw dw-delete-3"></i></a>
                                    <a class="btn btn-primary btn-sm" href="/kategori/{{$k->id_kategori}}/edit"><i class="icon-copy dw dw-pencil"></i></a>
                                </td>
                            </tr>
                            <div class="modal fade" id="confirmation-modal_{{$k->id_kategori}}" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body text-center font-18">
                                            ...
                                            <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                                                ...
                                                <div class="col-6">
                                                    <button type="button" onclick="event.preventDefault(); document.getElementById('delete-form_{{$k->id_kategori}}').submit();" class="btn btn-primary border-radius-100 btn-block confirmation-btn" data-dismiss="modal"><i class="fa fa-check"></i></button>
                                                    Ya
                                                </div>
                                                <form id="delete-form_{{$k->id_kategori}}" action="{{url("kategori/$k->id_kategori/delete")}}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                </form>
                                            </div>
