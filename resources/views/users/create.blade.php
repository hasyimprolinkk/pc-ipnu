                ...
                @csrf
                    ...
                    <div class="form-wrap max-width-600 mx-auto">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="roles" class="form-control selectpicker @error('roles') is-invalid @enderror" title="Roles Pengguna" data-size="3">
                                    <option value="user">User / Anggota</option>
                                    <option value="petugas">Petugas / Pengurus</option>		
